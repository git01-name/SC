...
<div class="right">
     ...
     <script type="text/javascript" src="${pageContext.request.contextPath }/js/jquery-1.8.3.min.js"></script>
         ...
         $(function(){
        	 $("#billCode").blur(function(){
        		 ...
        		 $.ajax({
        			 type:"GET",
        			 url:"${pageContext.request.contextPath}/billaddd",
        			 data:"billCode="+a,
        			 dataType:"json",
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/bill.dodo">
             <!--div的class 为error是验证错误，ok是验证成功-->
             <input type="hidden" name="method" value="add">
             <div class="">
                 <label for="billCode">订单编码：</label>
                 <input type="text" name="billCode" class="text" id="billCode" value=""> <span id="p"></span>
				 <!-- 放置提示信息 -->
				 <font color="red"></font>
             </div>
             <div>
